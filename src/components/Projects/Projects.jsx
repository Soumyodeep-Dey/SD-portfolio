...
function Projects() {
  ...
  return (
    <section id="projects" className="bg-gray-100 py-16 min-h-screen">
      <div className="container mx-auto">
        <h1 className="text-5xl font-bold text-center mb-12 text-indigo-700 animate-fadeInLeft">PROJECTS</h1>
          ...
          {projectList.map((project, index) => (
            <div key={index} className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
              ...
              <a
                ...
                className="text-indigo-600 font-semibold hover:underline mb-4 inline-block"
              >
                View Project
              </a>
