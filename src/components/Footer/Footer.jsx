function Footer() {
  ...
  return (
    <footer className="bg-light-100 dark:bg-dark-100 border-t border-light-300 dark:border-dark-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center justify-center space-y-4">
          {/* Main Footer Content */}
          <div className="text-center">
            <h3 className="text-lg font-semibold text-dark-900 dark:text-light-50 mb-2">
              Soumyodeep Dey
            </h3>
            <p className="text-dark-700 dark:text-light-300 max-w-md">
              Computer Science Engineering Student | Full-Stack Developer | Technical Writer
            </p>
          </div>
          ...
          <div className="flex space-x-6">
            <a
              ...
              className="text-dark-600 dark:text-light-400 hover:text-dark-900 dark:hover:text-light-50 transition-colors"
              aria-label="GitHub"
            >
